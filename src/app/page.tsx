...
import { OnlineJob, UserIntent } from '@/lib/types';
import TopNav from '@/components/navigation/TopNav';
import IntentSelector from '@/components/intent/IntentSelector';
import JobCard from '@/components/jobs/JobCard';
import { useRouter } from 'next/navigation';

import { useAlertMatcher } from '@/hooks/useAlertMatcher';
import Link from 'next/link';
import JobFilters, { FilterState } from '@/components/filters/JobFilters';

...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
    ...
    const navItems = [
        ...
        { href: '/admin/opportunities/create', label: 'Post New', icon: PlusCircle },
        ...
        <div className="flex min-h-screen bg-slate-50">
            ...
            <aside className="w-64 bg-white border-r border-slate-200 sticky top-0 h-screen hidden md:flex flex-col">
                <div className="p-6">
                    <Link href="/admin/dashboard" className="flex items-center gap-3">
                        ...
                        <span className="text-xl font-bold tracking-tight text-slate-900">YearHire <span className="text-xs font-medium text-slate-500 bg-slate-100 px-1.5 py-0.5 rounded ml-1">ADMIN</span></span>
                    </Link>
                </div>
            ...
            <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
                ...
                <header className="md:hidden bg-white border-b border-slate-200 p-4 flex items-center justify-between sticky top-0 z-20">
                    <Link href="/admin/dashboard" className="text-xl font-bold tracking-tight">YearHire</Link>

        ...
        <div className="space-y-8 animate-in fade-in duration-500">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-slate-500 font-medium">Monitoring reports and community issues.</p>
                </div>
                <button
                    onClick={loadFeedback}
                    className="bg-white border border-slate-200 px-4 py-2 rounded-xl text-slate-600 font-bold hover:bg-slate-50 transition-all active:scale-95 flex items-center gap-2"
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {[
                    { label: 'Total Reports', value: feedback.length, icon: MessageSquare, color: 'text-blue-600', bg: 'bg-blue-50' },
                    { label: 'Issue Hotspots', value: Object.keys(groupedFeedback).length, icon: AlertTriangle, color: 'text-orange-600', bg: 'bg-orange-50' },
                    { label: 'Resolved Rate', value: '0%', icon: CheckCircle2, color: 'text-emerald-600', bg: 'bg-emerald-50' }
                ].map((stat, i) => (
            ...
            {isLoading ? (
                ...
                <div className="bg-white border-2 border-dashed border-slate-200 rounded-3xl p-16 text-center">
                    ...
                    <p className="text-slate-500">No user reports have been filed recently.</p>
                </div>
            ) : (
                            ...
                            <div className="bg-slate-50/50 p-6 border-b border-slate-100 flex flex-col md:flex-row md:items-center justify-between gap-4">
                                ...
                                <div className="flex gap-2">
                                    <Link
                                        ...
                                        className="inline-flex items-center gap-2 px-4 py-2 bg-white border border-slate-200 rounded-xl text-sm font-bold text-slate-600 hover:bg-slate-50 transition-all active:scale-95"
                                    >

        ...
        <div className="max-w-7xl mx-auto space-y-6 md:space-y-8 pb-12 md:pb-20 px-2 md:px-4 pt-4 md:pt-0">
            ...
            {(analytics.urgent.brokenLinks > 0 || analytics.urgent.closingSoon48h > 0) && (
                <div className="bg-amber-500/10 border border-amber-500/30 rounded-xl p-4">
                    <div className="flex items-center gap-2 mb-2">
                        ...
                        <h3 className="text-sm font-black uppercase tracking-wider text-amber-600">Attention Required</h3>
                    </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-6">
                ...
                <div className="bg-card/50 rounded-xl border border-border/50 p-3 md:p-5">
                    ...
                    <h4 className="text-lg md:text-2xl font-black text-foreground italic leading-none">{healthPercentage}%</h4>
                ...
                <div className="bg-card/50 rounded-xl border border-border/50 p-3 md:p-5">
                    ...
                    <h4 className="text-lg md:text-2xl font-black text-foreground italic leading-none">{analytics.activity.applications30d}</h4>
                ...
                <div className="bg-card/50 rounded-xl border border-border/50 p-3 md:p-5">
                    ...
                    <h4 className="text-lg md:text-2xl font-black text-foreground italic leading-none">{analytics.activity.newUsers30d}</h4>
                    <p className="text-[9px] md:text-[10px] font-bold text-muted-foreground uppercase tracking-tighter mt-1">Last 30 Days</p>
                </div>
                ...
                <div className="bg-card/50 rounded-xl border border-border/50 p-3 md:p-5">
                    ...
                    <h4 className="text-lg md:text-2xl font-black text-foreground italic leading-none">{analytics.activity.bookmarks7d}</h4>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-card/30 rounded-xl border border-border/50 p-4 md:p-6 space-y-4">
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <span className="text-sm font-black">{analytics.linkHealth.retrying}</span>
                        </div>
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2">
                            ...
                            <span className="text-sm font-black">{analytics.linkHealth.broken}</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-card/30 rounded-xl border border-border/50 p-4 md:p-6 space-y-4">
                    ...
                    <div className="space-y-3">
                        <div className="flex items-center justify-between">
                            ...
                            <span className="text-sm font-black text-success">{analytics.opportunityStatus.published}</span>
                        </div>
                        <div className="flex items-center justify-between">
                            <span className="text-xs font-medium">Draft</span>
                            <span className="text-sm font-black text-amber-600">{analytics.opportunityStatus.draft}</span>
                        </div>
                        <div className="flex items-center justify-between">
                            <span className="text-xs font-medium">Archived</span>
                            <span className="text-sm font-black text-muted-foreground">{analytics.opportunityStatus.archived}</span>
                        </div>
                    </div>
                </div>
                ...
                {/* Feedback Summary */}
                <div className="bg-card/30 rounded-xl border border-border/50 p-4 md:p-6 space-y-4">
                    <h3 className="text-sm font-black uppercase tracking-wider">User Feedback (30d)</h3>
                    <div className="space-y-3">
